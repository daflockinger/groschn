...
import com.flockinger.groschn.blockchain.exception.AddressFormatException;
 ...
 * Internet.
 * <p>
 * You may want to consider working with {@link PrefixedChecksummedBytes} instead, which adds
 ...
 * <li>A string with non-alphanumeric characters is not as easily accepted as an account
 * number.</li>
...
public class Base58 {
  ...
  public static byte[] decode(String input) throws AddressFormatException {
    ...
    for (int i = 0; i < input.length(); ++i) {
      ...
      if (digit < 0) {
        throw new AddressFormatException("Invalid character in the input: " + c);
      }
  ...
  public static byte[] decodeChecked(String input) throws AddressFormatException {
    ...
    if (decoded.length < 4)
      throw new AddressFormatException("Input too short: " + decoded.length);
