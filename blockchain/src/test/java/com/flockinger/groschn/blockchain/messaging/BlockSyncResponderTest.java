...
public class BlockSyncResponderTest extends BaseCachingTest {
  ...
  public void testRespond_withValidRequestAndEnoughBlocks_shouldRespondNormal() {
    ...
    when(blockService.findBlocks(anyLong(), anyLong())).thenReturn(someBlocks(10));
    ...
    assertEquals("verify that response entity size is correct", 10l, response.get().getEntities().size());
